...
- **Retirement date = 19 June 2026 = Rupert's 60th birthday** (the plan's selected retirement age is 60, not 65).
- **Estimated fund value at 19 Jun 2026: £14,132.62.** For a DC/Flexible Retirement Account this ≈ the CETV  
  for Form E — Midel value now confirmed in writing.
- **Deferral:** if Aviva don't hear by 19 Jun 2026, they auto-change the retirement date to the **74th birthday**.  
  Not fixed — changeable any time by calling. So **doing nothing = the deferral we wanted.**
- **Access is NOT locked by the retirement date.** Rupert is 60 (above minimum pension age 55), so he could take  
  it whenever; the "74" date does not gate access. Benefits must be taken by the **75th birthday** under this plan  
  (can transfer at 75 for more options).
- ⚠️ **Lifestyling nuance:** this fund has *already* been de-risked (moved to lower-risk investments) as it  
  approached the 19 Jun 2026 date. If deferred, it **stays parked in lower-risk** — Aviva won't move it back to  
  growth unless instructed. For "don't draw before settlement, leave it sitting" this is broadly fine and keeps  
  value stable for Form E (low volatility); the cost is low growth on the £14k.
...
- **Self-service statement route tried and ruled out (18 Aug 2026).** Route: Mailbox → Send secure  
  ...
  1.. **Neither pull ever included a transfer value or any valuation figure at all** — this  
...
PAG guidance recommends a PODE report where CETVs exceed £100k. See [[IFAs]].
