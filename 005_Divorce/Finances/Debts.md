...
- Ann's loans: if no written agreement, complicates consent order. Flag to solicitor early
- All joint debts will be a snapshot figure in financial disclosure

### Strategy: Decouple

Split joint cards so each party takes their portion independently (e.g. balance transfers to 0% cards).

- Identify which joint cards are at 0% vs accruing interest
...
## Related analysis
- [[2026-07-22_card-split-loan-affordability-and-heather-risk]] — lender/term comparison for the £7,500 consolidation loan (Halifax recommended over Tesco), full monthly affordability breakdown for both "split goes ahead" and "split falls through" scenarios, and the risk of drawing the loan before Heather actually confirms the card split
