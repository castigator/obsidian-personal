...
| Detail | Information |
|--------|-------------|
| **Full name** | Stuart D Hughes |
| **Qualification year** | 1993 |
| **Years of experience** | 33 years (qualified 1993) |
| **Education** | BSc Law, University of Plymouth (1989-1992) |
| **Joined Greene & Greene** | July 2012 |
| **Partnership** | December 2013 |
...
- Current: Managing Partner AND Head of Family & Relationships department
...
- Financial remedies in divorce proceedings
- Separation and property disputes (TOLATA claims)
- Child Arrangement Orders and custody matters
- Specific Issue and Prohibited Steps Orders
- Domestic abuse injunctive relief
- Financial Provision claims under Children Act 1989 (Schedule 1)
...
**Notable:** The team handles high-value matters involving assets in excess of £30 million, and works nationally and internationally — not just regional.
...
|---------------|--------|
| **Law Society Family Law Accreditation Scheme** | Member |
| **Resolution** | Member |
| **Collaborative lawyer** | Yes |
| **All Issues Mediator** | Yes (trained by Resolution) |
| **Arbitrator (IFLA)** | Not found — no evidence of arbitration accreditation |
...
- No regular blog posts found on the Greene & Greene website under his name
- No other media appearances, podcasts, or conference talks found in public sources
...
4. *"Stuart is an amazingly intelligent bloke, knows his field inside out."*
...
| Role | Detail |
|------|--------|
| **Managing Partner** | Yes — since January 2018 |
| **Head of Family & Relationships** | Yes — since joining in 2012 |
| **Finance Partner** | Yes (per RocketReach) |

He runs both the firm and the family department. The family team currently comprises:
- **Stuart Hughes** — Partner (Head of Family)
- **Melanie Pilmer** — Partner (also ranked: Chambers Band 2, Legal 500 Leading Partner)
- **Emma Alfieri** — Legal Director (Legal 500 Leading Associate)
- **Bobbie-Rae Durant** — Trainee Solicitor
...
| Activity | Detail |
|----------|--------|
| **Bury Abbey Rotary Club** | Member |
| **Bury St Edmunds Rugby Club** | Member |
| **Pro bono work** | Not specifically mentioned |
...
| Channel | Detail |
|---------|--------|
| **Direct phone** | 01284 717493 |
| **Email** | stuarthughes@greene-greene.com |
| **Firm address** | 80 Guildhall Street, Bury St Edmunds, IP33 1QB |
| **LinkedIn** | linkedin.com/in/stuarthughessolicitor/ |
...
- **SRA number (firm):** 50190
- **No legal aid** — the family team does not offer legal aid
- **Hourly rate:** £450/hr (confirmed on call 26 May 2026). First consultation minimum 1.5 hours (£675+).
- **Firm is an ABS** (Alternative Business Structure) — registered on SRA's licensed body register
...
|--------|---------------------|----------------------------|
| **Chambers ranking** | Band 1 individual | TBC |
| **Legal 500** | Leading Partner | TBC |
| **Years qualified** | 33 (since 1993) | TBC |
| **Hourly rate** | £450/hr | £335/hr + VAT (£402) |
| **Mediator** | Yes (all issues) | TBC |
| **Collaborative lawyer** | Yes | TBC |
| **Law Society accreditation** | Yes | TBC |
| **Managing Partner** | Yes | TBC |
| **High-value experience** | Cases >£30m | TBC |
| **Location** | Bury St Edmunds | Colchester/Ipswich |

**Key strengths of Hughes:** Band 1 Chambers ranking is the top tier for an individual lawyer in the region. The volume and consistency of praise from independent sources (barristers, judges, opposing solicitors) is exceptional. The "strategist" and "several steps ahead" quotes are particularly relevant for a contested financial remedy case. His dual role as Managing Partner suggests he is the most senior family lawyer in a well-established firm. The team handles cases well above your asset bracket (£30m+), so your case will be well within their competence.

**Potential concerns:** As Managing Partner, he may be stretched for time. Worth asking about his current caseload and whether he would handle your case personally or delegate to Melanie Pilmer or Emma Alfieri. Also ask about his hourly rate — if he is significantly more or less than £335/hr, that affects the comparison.
