...
- [!] **Use the 16 Jun → 4 Nov window to sort the finances** — gather CETVs (Heather's Prudential DB + Rupert's three Aviva), settlement modelling, then consent order. This is what paces the case, not the clock. See [[Clean Break]] / [[005_Divorce/Pensions]].
...
- [!] **RBS called back 30 Jul** (voicemail, "Jeanette") — first response since the 27 Jul letter
  (which already requested a fresh redemption statement). Call back on **0345 301 0101** — see
...
| Person | Role |
|--------|------|
| Rupert Thomas | Me — living at [[19 Westgate]] |
| Heather Thomas | Wife (separating) — living at Maple Tree House, Pebmarsh |
| Mandy Zimmer | Rupert's partner — living with Rupert |
| Dylan Thomas | Son, 27 — independent |
| Daisy Thomas | Daughter, 26 — independent |
| Lucy Thomas | Daughter, 21 — at university. ~£200/mo food money |
| Stuart Thomas | Rupert's father — personal loan of £3,000 |
| Ann | Heather's mother — parents loaned £8,800 (joint debt) |
...
Joint estate planning with Co-op Legal Services (ref 6897421), will submitted 5 Oct 2024. These wills need reviewing/revoking — divorce does not automatically revoke a will made during the marriage.

## Goals

1. 50/50 split of all matrimonial assets
2. Clean break consent order — no ongoing spousal maintenance
3. Resolve house sale as quickly as financially sensible
4. Decouple from all joint debts
